...
class CategoriesConstants {
    ...
    const GRANDES_DOMESTICOS = 'GRANDES DOMÉSTICOS';
        //MAQ LOUCA
            const ACESSORIOS_MLL = 'ACESSORIOS MAQ LOUÇA';
        
        //ENC
            const FRIO_ENC = 'ENC FRIO';
    ...
    const ACESSORIOS_ENC = 'ACESSORIOS ENC';
    ...
    const FRIO = 'FRIO';
    const ACESSORIOS_MAQ_ROUPA = 'ACESSORIOS MAQ ROUPA';
