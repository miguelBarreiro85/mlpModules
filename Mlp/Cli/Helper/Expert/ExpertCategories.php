                    ...
                    switch ($familia) {
                        case 'Computadores e Tablets':
                            ...
                            switch ($subFamilia) {
                                ...
                                case 'Tablets':
                                    $subFamilia = self::TABLETS;
                                    return [$gama,$familia,$subFamilia];
                                case 'Acessórios Tablets':
                                    $subFamilia = self::ACESSORIOS_TABLETS;
                                    return [$gama,$familia,$subFamilia];
                                case 'Acessórios Notebooks':
                                    $subFamilia = self::ACESSORIOS_NOTEBOOKS;
                                    return [$gama,$familia,$subFamilia];
                                case 'Outros':
                                    $subFamilia = self::ACESSORIOS_NOTEBOOKS;
                        ...
                        case 'Monitores':
                            $familia = self::MONITORES;
                            switch ($subFamilia) {
                                case 'LFD':
                                case 'TFT':
                                case 'LED':
                                    $subFamilia = self::MONITORES_PC;
                                    return [$gama,$familia,$subFamilia];
                                case 'Curvo':
                                    $subFamilia = self::MONITORES_PC_CURVO;
                                    return [$gama,$familia,$subFamilia];
                                case 'LED TV':
                                    $subFamilia = self::MONITORES_C_TV;
                                    return [$gama,$familia,$subFamilia];
                                case 'Tácteis':
                                    $subFamilia = self::MONITORES_TACTEIS;
                                    return [$gama,$familia,$subFamilia];
                                default:
                                    return [$gama,$familia,$subFamilia];
                            }
                        ...
                        case 'Impressoras':
                            ...
                            switch ($subFamilia) {
                                case 'Acessórios':
                                case 'Consumíveis':
                                    $subFamilia = self::ACESSORIOS_IMPRESSORAS;
                                    return [$gama,$familia,$subFamilia];
                                case 'Jacto de Tinta':
                                    $familia = self::IMPRESSORAS;
                                    $subFamilia = self::IMPRESSORAS_JACTO_DE_TINTA;
                                    return [$gama,$familia,$subFamilia];
                                default:
                                    return [$gama,$familia,$subFamilia];
                        ...
                        case 'Integração e Periféricos':
                            $familia = self::ACESSORIOS_INFORMATICA;
                            switch ($subFamilia) {
                                case 'UPS':
                                    $subFamilia = self::UPS;
                                    return [$gama,$familia,$subFamilia];
                                case 'Webcams':
                                    $subFamilia = self::WEB_CAMS;
                                    return [$gama,$familia,$subFamilia];
                                ...
                                case 'Redes':
                                    $subFamilia = self::REDES_CABOS;
                                    $logger->info(self::VERIFICAR_SUBFAMILIA.$sku);
                                    return [$gama,$familia,$subFamilia];
                                case 'Transporte':
                                    $subFamilia = self::MALAS_BOLSAS_INFORMATICA;
                                    return [$gama,$familia,$subFamilia];
                        ...
                        case 'Software':
                            $familia = self::INFORMATICA_SOFTWARE;
                            switch ($subFamilia) {
                                case 'Segurança':
                                    $subFamilia = self::INFORMATICA_SOFTWARE_SEGURANCA;
                                    return [$gama,$familia,$subFamilia];
                                case 'POS':
                                    $subFamilia = self::INFORMATICA_SOFTWARE_POS;
                                    return [$gama,$familia,$subFamilia];
                                default:
                                    return [$gama,$familia,$subFamilia];
                                    break;
                        ...
                        case 'Gaming':
                            ...
                            switch ($subFamilia) {
                                case 'Acessórios Playstation':
                                    $subFamilia = self::ACESSORIOS_PLAYSTATION;
                                    return [$gama, $familia, $subFamilia];
                                case 'Consolas Playstation':
                                    $subFamilia = self::CONSOLAS_PLAYSTATION;
                                    return [$gama, $familia, $subFamilia];
                                case 'Jogos Playstation':
                                    $subFamilia = self::JOGOS_PLAYSTATION;
                                    return [$gama, $familia, $subFamilia];
                                case 'Acessórios PC Gaming':
                                    $subFamilia = self::ACESSORIOS_PC_GAMING;
                                    return [$gama, $familia, $subFamilia];
                                default:
                                    return [$gama, $familia, $subFamilia];
                            }
                    ...
                    switch ($familia) {
                        case 'TV':
                            switch ($subFamilia) {
                                ...
                                case 'Acessórios':
                                    $familia = self::ACESSORIOS_IMAGEM_E_SOM;
                                    $subFamilia = self::ACESSORIOS_TV;
                                    return [$gama,$familia,$subFamilia];
                                case 'Cabos':    
                                    $familia = self::ACESSORIOS_IMAGEM_E_SOM;
                                    $subFamilia = self::CABOS_TV;
                                    return [$gama,$familia,$subFamilia];
                            
                                case 'De 50 a 65 Polegadas':
                                    $familia = self::TELEVISAO;
                                    $subFamilia = self::TV_LED_50_60;
                                    return [$gama,$familia,$subFamilia];
                                ...
                                case 'Mais de 65 Polegadas':
                                    $familia = self::TELEVISAO;
                                    $subFamilia = self::TV_LED_M65;
                                    return [$gama,$familia,$subFamilia];
                                case 'Hotelaria':
                                    $familia = self::TELEVISAO;
                                    $subFamilia = self::TV_HOTELARIA;
                                    return [$gama,$familia,$subFamilia];
                                default:
                                    return [$gama,$familia,$subFamilia];
                            }
                        case 'Projectores':
                            $familia = self::PROJECTORES;
                            switch ($subFamilia) {
                                case 'Portátil':
                                    $subFamilia = self::PROJECTORES_PORTATEIS;
                                    return [$gama, $familia, $subFamilia];
                                case 'Mesa':
                                    $subFamilia = self::PROJECTORES_MESA;
                                    return [$gama, $familia, $subFamilia];
                                case 'Acessórios':
                                    $subFamilia = self::ACESSORIOS_PROJECTORES;
                                    return [$gama, $familia, $subFamilia];
                                default:
                                    return [$gama, $familia, $subFamilia];  
                            }
                        ...
                        case 'Sistema Áudio':
                            switch ($subFamilia) {
                                case 'Electrónica Auto':
                                    $gama = self::IMAGEM_E_SOM;
                                    $subFamilia = self::CAR_AUDIO;
                                    $subFamilia = self::AUTO_RADIOS;
                                    return [$gama, $familia, $subFamilia];
                        ...
                        case 'Comunicações Móveis':
                            switch ($subFamilia) {
                                case 'Car Kits':
                                    ...
                                    $familia = self::CAR_AUDIO;
                                    $subFamilia = self::CAR_KITS;
                                    return [$gama, $familia, $subFamilia];
                                case 'Alimentação':
                ...
                case 'Energia':
                    ...
                    switch ($familia) {
                        ...
                        case 'Iluminação':
                            ...
                            switch ($subFamilia) {
                                ...
                                case 'Lâmpadas':
                                    ...
                                    return [$gama, $familia, $subFamilia];
                                case 'Diversos':
                                    $subFamilia = self::DIVERSOS_ILUMINACAO;
                                    return [$gama, $familia, $subFamilia];
                                default:
                                    return [$gama, $familia, $subFamilia];
                            }
                        case 'Pilhas e Carregadores':
                            ...
                            switch ($subFamilia) {
                                ...
                                case 'Carregadores':
                                    ...
                                    return [$gama, $familia, $subFamilia];
                                case 'Comando':
                                    $subFamilia = self::PILHAS_COMANDO;
                                    return [$gama, $familia, $subFamilia];
                                case 'Baterias':
                                    $subFamilia = self::BATERIAS;
                                    return [$gama, $familia, $subFamilia];
                                default:
                                    return [$gama, $familia, $subFamilia];
                            }
                        case 'Extensões / Cabos':
                            $familia = self::EXTENSOES_CABOS;
                            switch ($subFamilia) {
                                case 'Extensões Múltiplas':
                                    $subFamilia = self::EXTENSOES_MULTIPLAS;
                                    return [$gama, $familia, $subFamilia];
                        ...
                        case 'Acessórios':
                            switch ($subFamilia) {
                                case 'Alimentação':
                                    $familia = self::ACESSORIOS_ILUMINACAO;
                                    $subFamilia = null;
                                    return [$gama, $familia, $subFamilia];
                    ...
                    switch ($familia) {
                        case 'Máquina Lavar Loiça':
                            switch ($subFamilia) {
                                case 'Acessórios':
                                case 'Consumíveis':
                                    $subFamilia = self::ACESSORIOS_MLL;
                                    return [$gama, $familia, $subFamilia];
                        ...
                        case 'Frio':
                            ...
                            switch ($subFamilia) {
                                ...
                                case 'Acessórios':
                                case 'Consumíveis':
                                    $subFamilia = self::ACESSORIOS_FRIO;
                                    return [$gama, $familia, $subFamilia];
                                case 'Combinados':
                        ...
                        case 'Encastre':
                            ...
                            switch ($subFamilia) {
                                case 'Máquinas de Secar Roupa':
                                    $subFamilia = self::MAQ_SECAR_ROUPA_ENCASTRE;
                                    return [$gama, $familia, $subFamilia];
                                case 'Exaustores':
                                case 'Chaminés':
                                ...
                                case 'Máquinas de Lavar/Secar Roupa':
                                    ...
                                    return [$gama, $familia, $subFamilia];
                                case 'Lava-Loiças':
                                    $subFamilia = self::LAVA_LOUCAS;
                                    return [$gama, $familia, $subFamilia];
                                case 'Frio':
                                    $subFamilia = self::FRIO_ENCASTRE;
                                    $logger->info(self::VERIFICAR_SUBFAMILIA.$sku);
                                    return [$gama, $familia, $subFamilia];
                                case 'Torneiras':
                        ...
                        case 'Climatização':
                            ...
                            switch ($subFamilia) {
                                ...
                                case 'Humidificadores':
                                    ...
                                    $subFamilia = self::HUMIDIFICADORES;
                                    return [$gama,$familia,$subFamilia];
                                ...
                                case 'Acessórios':
                                case 'Consumíveis':
                                    $familia = self::ACESSORIOS_CLIMATIZACAO;
                                    $subFamilia = null;
                                    return [$gama,$familia,$subFamilia];
                                case 'Purificador de Ar':
                                    $familia = self::TRATAMENTO_DE_AR;
                                    $subFamilia = self::PURIFICADORES_AR;
                                    return [$gama,$familia,$subFamilia];
                                case 'Ventilação':
                        ...
                        case 'Cozinha':
                            ...
                            switch ($subFamilia) {
                                ...
                                case 'Acessórios e Peças':
                                    $subFamilia = self::ACESSORIOS_COZINHA;
                                    return [$gama,$familia,$subFamilia];
                                case 'Consumíveis':
                                    $subFamilia = self::ACESSORIOS_COZINHA;
                                    return [$gama,$familia,$subFamilia];
                                ...
                                case 'Grelhadores':
                                    ...
                                    return [$gama,$familia,$subFamilia];
                                case 'Picadoras':
                                    $subFamilia = self::APARELHOS_DE_COZINHA;
                                    return [$gama,$familia,$subFamilia];
                                case 'Espremedores':
                        ...
                        case 'Cuidados Pessoais':
                            ...
                            switch ($subFamilia) {
                                case 'Escovas de Dentes':
                                    $subFamilia = self::ESCOVAS_DE_DENTES;
                                    return [$gama,$familia,$subFamilia];
                                case 'Depiladoras':
                                    $subFamilia = self::DEPILADORAS;
                                    return [$gama,$familia,$subFamilia];
                                case 'Acessórios':
                                    $subFamilia = self::ACESSORIOS_ASSEIO;
                                    return [$gama,$familia,$subFamilia];
                                case 'Cuidados Masculinos':
                                    $subFamilia = self::CUIDADOS_MASCULINOS;
                                    $logger->info(self::VERIFICAR_SUBFAMILIA.$sku);
                                    return [$gama,$familia,$subFamilia];
                                case 'Saúde':
                                    $subFamilia = self::SAUDE_BELEZA;
                                    return [$gama,$familia,$subFamilia];
                                case 'Secadores':
                        ...
                        case 'Tratamento de Tecidos':
                            ...
                            switch ($subFamilia) {
                                ...
                                case 'Tábuas de Engomar':
                                    ...
                                    return [$gama,$familia,$subFamilia];
                                case 'Acessórios':
                                    $subFamilia = self::ACESSORIOS_CUIDADOS_ROUPA;
                                    return [$gama,$familia,$subFamilia];
                        ...
                        case 'Limpeza de Pavimentos':
                            ...
                            switch ($subFamilia) {
                                ...
                                case 'Máquinas a Vapor':
                                    $subFamilia = self::MAQUINAS_LIMPEZA_VAPOR;
                                    return [$gama,$familia,$subFamilia];
                                ...
                                case 'Mini-Aspiradores':
                                    ...
                                    return [$gama,$familia,$subFamilia];
                                case 'Outros':
                                    $subFamilia = self::OUTROS_APARELHOS_LIMPEZA;
                                    return [$gama,$familia,$subFamilia];
                                case 'Aspiradores':
                                    $subFamilia = self::ASPIRADORES;
                                    $logger->info(self::VERIFICAR_SUBFAMILIA.$sku);
                                    return [$gama,$familia,$subFamilia];
                        ...
                        case 'Microondas':
                            ...
                            switch ($subFamilia) {
                                ...
                                case 'Combinado':
                                    ...
                                    return [$gama,$familia,$subFamilia];
                                case 'Consumíveis':
                                    $subFamilia = self::ACESSORIOS_MICROONDAS;
                                    return [$gama,$familia,$subFamilia];
                                default:
                                    return [$gama,$familia,$subFamilia];        
                                    break;
